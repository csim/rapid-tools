...
namespace Rapid.Tools.SPDeploy.AddIn.Proxies.SiteData
{
	...
	public partial class SiteDataWebService : System.Web.Services.Protocols.SoapHttpClientProtocol
	{
		...
		/// <remarks/>
		public uint EndGetSiteAndWeb(System.IAsyncResult asyncResult, out string strSite, out string strWeb)
		{
		...
		/// <remarks/>
		public uint EndGetSite(System.IAsyncResult asyncResult, out _sSiteMetadata sSiteMetadata, out _sWebWithTime[] vWebs, out string strUsers, out string strGroups, out string[] vGroups)
		{
			object[] results = this.EndInvoke(asyncResult);
			sSiteMetadata = ((_sSiteMetadata)(results[1]));
			vWebs = ((_sWebWithTime[])(results[2]));
		...
		/// <remarks/>
		public uint EndGetWeb(System.IAsyncResult asyncResult, out _sWebMetadata sWebMetadata, out _sWebWithTime[] vWebs, out _sListWithTime[] vLists, out _sFPUrl[] vFPUrls, out string strRoles, out string[] vRolesUsers, out string[] vRolesGroups)
		{
			object[] results = this.EndInvoke(asyncResult);
			sWebMetadata = ((_sWebMetadata)(results[1]));
			vWebs = ((_sWebWithTime[])(results[2]));
		...
		/// <remarks/>
		public uint EndGetList(System.IAsyncResult asyncResult, out _sListMetadata sListMetadata, out _sProperty[] vProperties)
		{
			object[] results = this.EndInvoke(asyncResult);
			sListMetadata = ((_sListMetadata)(results[1]));
			vProperties = ((_sProperty[])(results[2]));
		...
		/// <remarks/>
		public System.IAsyncResult BeginGetListItems(string strListName, string strQuery, string strViewFields, uint uRowLimit, System.AsyncCallback callback, object asyncState)
		{
		...
		/// <remarks/>
		public uint EndEnumerateFolder(System.IAsyncResult asyncResult, out _sFPUrl[] vUrls)
		{
			object[] results = this.EndInvoke(asyncResult);
			vUrls = ((_sFPUrl[])(results[1]));
			return ((uint)(results[0]));
		...
		/// <remarks/>
		public uint EndGetAttachments(System.IAsyncResult asyncResult, out string[] vAttachments)
		{
			object[] results = this.EndInvoke(asyncResult);
			vAttachments = ((string[])(results[1]));
			return ((uint)(results[0]));
		...
		/// <remarks/>
		public uint EndGetListCollection(System.IAsyncResult asyncResult, out _sList[] vLists)
		{
			object[] results = this.EndInvoke(asyncResult);
			vLists = ((_sList[])(results[1]));
			return ((uint)(results[0]));
		...
		/// <remarks/>
		public System.IAsyncResult BeginGetContent(ObjectType objectType, string objectId, string folderUrl, string itemId, bool retrieveChildItems, bool securityOnly, string lastItemIdOnPage, System.AsyncCallback callback, object asyncState)
		{
			return this.BeginInvoke("GetContent", new object[] {
                    ...
                    retrieveChildItems,
                    securityOnly,
                    lastItemIdOnPage}, callback, asyncState);
		}

		/// <remarks/>
		public string EndGetContent(System.IAsyncResult asyncResult, out string lastItemIdOnPage)
		{
			object[] results = this.EndInvoke(asyncResult);
			lastItemIdOnPage = ((string)(results[1]));
			return ((string)(results[0]));
		...
		/// <remarks/>
		public System.IAsyncResult BeginGetSiteUrl(string Url, System.AsyncCallback callback, object asyncState)
		{
			return this.BeginInvoke("GetSiteUrl", new object[] {
                    Url}, callback, asyncState);
		}

		/// <remarks/>
		public uint EndGetSiteUrl(System.IAsyncResult asyncResult, out string siteUrl, out string siteId)
		{
			object[] results = this.EndInvoke(asyncResult);
			siteUrl = ((string)(results[1]));
			siteId = ((string)(results[2]));
		...
		/// <remarks/>
		public System.IAsyncResult BeginGetChanges(ObjectType objectType, string contentDatabaseId, string LastChangeId, string CurrentChangeId, int Timeout, System.AsyncCallback callback, object asyncState)
		{
		...
		/// <remarks/>
		public string EndGetChanges(System.IAsyncResult asyncResult, out string LastChangeId, out string CurrentChangeId, out bool moreChanges)
		{
			object[] results = this.EndInvoke(asyncResult);
			LastChangeId = ((string)(results[1]));
			CurrentChangeId = ((string)(results[2]));
